function words(x)
{
	...
	case 5:
		...
		break;
	case 6:
		var word = new Array("aeklt", "latke","talk","teak","tale","tael","teal","kale","leak","lake","tela","late","take","lat","elk","let","alt","eat","ate","ale","tea");
		break;
	case 7:
		var word = new Array("zuqlti", "quilt", "lutz", "quit", "quiz", "zit", "lit", "til");
		break;
	case 8:
		var word = new Array("abcdef", "decaf", "faced", "aced", "abed", "cade", "cafe", "deaf", "fade", "bead", "bade", "face", "dace", "cad", "cad", "fad", "fed", "ace", "bed", "bad", "dab", "cab", "deb");
		break;
	}
	return word;
}
